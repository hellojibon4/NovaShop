          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex items-center gap-3 text-slate-400 dark:text-slate-500 pt-2">
              <a
                ...
                className="w-9 h-9 rounded-xl bg-slate-50 dark:bg-slate-800 flex items-center justify-center hover:bg-violet-100 hover:text-violet-600 dark:hover:bg-violet-950 dark:hover:text-violet-300 transition-colors cursor-pointer"
              >
